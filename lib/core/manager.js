...
var Manager = module.exports = function() {
  ...
  this.vol = {
    ...
    to: function() {
      ...
      if (arguments.length==1 || arguments.length==2) {
        arguments[0] = scale(arguments[0],1,0,0,-100)
      } else if (arguments.length==3) {
        arguments[0] = scale(arguments[0],1,0,0,-100)
        arguments[1] = scale(arguments[0],1,0,0,-100)
      }
  ...
  this.sine = {
    ...
    vol: function() {
      arguments[0] = Math.pow(arguments[0],1/5)
      if (arguments.length==1 || arguments.length==2) {
        arguments[0] = scale(arguments[0],1,0,-10,-100)
      } else if (arguments.length==3) {
        arguments[0] = scale(arguments[0],1,0,-10,-100)
        arguments[1] = scale(arguments[0],1,0,-10,-100)
      }
      m.rampValue(this.ugen.volume,arguments)
    },
    start: function() {
  ...
  this.noise = {
    ...
    vol: function() {
      arguments[0] = Math.pow(arguments[0],1/5)
      if (arguments.length==1 || arguments.length==2) {
        arguments[0] = scale(arguments[0],1,0,-10,-200)
      } else if (arguments.length==3) {
        arguments[0] = scale(arguments[0],1,0,-10,-200)
        arguments[1] = scale(arguments[0],1,0,-10,-200)
      }
...
/**
  */
Manager.prototype.nofx = function(limit) {
